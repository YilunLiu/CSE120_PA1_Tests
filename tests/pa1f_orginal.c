 ...
 *	variable (CONTEXT is a special type in UMIX) pointed to by c.
 ...
 * you are provided with a variable type named CONTEXT, defined in sys.h,
 * which you can use to declare variables to store process contexts, as
 * in the declaration:
 *
 * 	CONTEXT ctxt;
 *
